...
class Main(tk.Frame):
    ...
    def delete_records(self):
        for selection_items in self.tree.selection():
            self.db.cursor.execute("DELETE FROM employees WHERE id=?", (self.tree.set(selection_items, "#1")))
        self.db.conn.commit()
        self.view_records()
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        search_btn = ttk.Button(self, text="Поиск")
